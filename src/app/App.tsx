...
function App() {
  ...
  const defaultAgents = allAgentSets[agentSetKey];
  const [selectedAgentName, setSelectedAgentName] = useState<string>(
    defaultAgents[0]?.name || ""
  );
  const [selectedAgentConfigSet] = useState<RealtimeAgent[] | null>(
    defaultAgents
  );
  ...
  // Scenario and agent selection are fixed to default values
